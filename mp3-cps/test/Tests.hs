...
allTests = [ (tests_tags, "tags")
           ...
           -- , (tests_cpsExp_more, "cpsExp: More tests") -- Extra
...
expApK = [ "f a k"
         , "f (g + 3) k"
         , "p (12 * y) k"
         , "h i (\\v2 -> g v2 (\\v1 -> f v1 k))"
         , "h (4 * 2) (\\v2 -> g v2 (\\v1 -> f v1 k))"
         ]
...
tests_cpsExp_more :: [Bool]
tests_cpsExp_more = cpsExpAll (expMore, expMoreK)
